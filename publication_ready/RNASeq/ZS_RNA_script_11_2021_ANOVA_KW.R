...
comparisons <-
  sample_data %>%
  dplyr::select(samples, sample_age_w, contains("FT07"),contains("FT08"),contains("FT09"),contains("FT10"), status, VGB_treatment, vgb_pretreatment)
